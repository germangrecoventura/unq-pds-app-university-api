...
CREATE TABLE `commission` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `four_month_period` int NOT NULL,
  `year` int NOT NULL,
...
CREATE TABLE `repository_branches` (
  ...
  UNIQUE KEY `UK_jeaijtmsedn8f4vr0fi18n2cv` (`branches_name`),
  ...
  CONSTRAINT `FKk1k7ggxsyhqrsrnxyhmw4m21a` FOREIGN KEY (`branches_name`) REFERENCES `branch` (`name`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `student` (
  ...
  UNIQUE KEY `UK_kkq04ui961mvrh7nu83j4xn2e` (`token_github`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2023-05-14 19:46:16
